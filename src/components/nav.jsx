                          ...
                          <MenuAdapter.Root to={`/dashboard`}>
                            ...
                            <MenuAdapter.Positioner>
                              <MenuAdapter.Content px={2}>
                                ...
                                <Button my={1} as={MenuAdapter.Item} display={'flex'} justifyContent={'space-between'} onClick={logout} variant={'ghost'} w={'100%'}> Sign Out  <RiLogoutBoxRLine className='icon' /> </Button>
                                <Button my={1} as={MenuAdapter.Item} display={'flex'} justifyContent={'space-between'} variant={'ghost'} w={'100%'}> Contact Support <RiHeadphoneLine className='icon' />  </Button>
                              </MenuAdapter.Content>
                            </MenuAdapter.Positioner>
                          </MenuAdapter.Root>
              }
