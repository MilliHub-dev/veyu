      ...
      <VStack spacing={6} align="stretch">
        ...
        <HStack justify="space-between" flexWrap="wrap" gap={2}>
          <HStack>
            ...
            <Heading size="md">Mechanic Locations</Heading>
        ...
        <Text color="gray.600">
          Manage your mechanic shop locations. Customers will be able to see these locations on your profile.
        </Text>
          ...
          >
            <VStack spacing={3}>
              ...
              <Text color="gray.400" fontSize="sm">
                Add your shop locations so customers can find you
              </Text>
              <Button
                leftIcon={<FaPlus />}
                colorScheme="orange"
