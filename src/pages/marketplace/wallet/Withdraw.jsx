...

        {
          step === 1 ? (
            <Box borderRadius="20px" w="90%" placeItems="center" maxW={'400px'} px={4} py={7} border="1px solid lavender">
              <Heading size="md" my={4}> Withdraw </Heading>
              <Text my={10} size="md" fontWeight="600"> How much are you withdrawing? </Text>
              <Heading size="md" my={2} color="primary"> Available Balance: {currency.symbol}{commaInt(2000000)} </Heading>
              ...
              <Button onClick={() => setStep(1)} isDisabled={amount < 50000 } display="block" bg="primary" colorScheme="blue" w="full" flex={1} mt="3rem" size="lg"> PROCEED </Button>
            </Box>
          ) : (
            <Box borderRadius="20px" w="90%" placeItems="center" maxW={'400px'} px={4} py={7} border="1px solid lavender">
              <Heading size="md" my={4}> Withdraw </Heading>
              ...
              <Box as={FormControl} isRequired w="full">
                ...
                <Input  isRequired py={4} w="full" type="" name="account-number" />
              </Box>
